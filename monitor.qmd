...
3. Testnavigation:
  ...
  b. Klicken Sie auf den hellgrün gefärbten Block, in dem sich die Testperson gerade befindet (@fig-solution-3)
  c. Betätigen Sie die Schaltfläche „Springe zu Block“ (@fig-solution-4). Die Person wird somit wieder an den Anfang des Blocks geleitet.
  d. Wechseln Sie zum Gerät der Testperson. Überspringen Sie die defekte Aufgabe, indem Sie in der oberen Navigationsleiste direkt (nicht über die Pfeiltasten!) die nachfolgende Aufgabe auswählen (hier im Beispiel Aufgabe 4, siehe @fig-solution-4).
    - **Ausnahme:** Liegen keine weiteren Aufgaben nach der defekten Aufgabe vor, entfällt dieser Schritt d. Die Testperson wurde auf den Anfang des Blocks zurückgesetzt und hat die Möglichkeit, die bisher bearbeiteten Aufgaben noch einmal zu kontrollieren. Nach Ablauf der Zeit wird die Testperson automatisch in den nächsten Abschnitt weitergeleitet.





1.  **Fall 1:** Sofern noch weitere außer der betreffenden Aufgabe (z. B. Aufgabe 2 und/oder Aufgabe 4) vorliegen:
