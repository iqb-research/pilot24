...
- Wenn es sich um ein "Pflichtmedium" handelt (d. h. wenn man nicht zur nächsten Teilaufgabe oder zur nächsten Aufgabe navigieren kann): Nutzen Sie die [Testleitungskonsole](/monitor.qmd), um die Testperson zum Anfang des Abschnitts springen zu lassen. Überspringen Sie über die Navigationsleiste diese Teilaufgabe.
